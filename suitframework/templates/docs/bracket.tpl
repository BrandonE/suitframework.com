...
<p>[gettext]Offset closing brackets not used for attributes.[/gettext]</p>

<fieldset>
    <legend><a id="syntax" href="#syntax">[gettext]Syntax[/gettext]</a></legend>
    [gettext][skip][string][/skip][/gettext]
</fieldset>
...
<fieldset>
    ...
    <fieldset>
        ...
        <p>[gettext]A string contained in brackets.[/gettext]</p>
    </fieldset>
</fieldset>

<fieldset>
    <legend><a id="output" href="#output">[gettext]Output[/gettext]</a></legend>
    <p>[gettext]The entire statement treated as plain text.[/gettext]</p>
</fieldset>

<fieldset>
    <legend><a id="seealso" href="#seealso">[gettext]See Also[/gettext]</a></legend>
        <ul>
            <li><a href="[url controller="root" action="template" templatefile="tryit" parameter1="templating" parameter2="bracket" /]">[gettext]Try It[/gettext]</a></li>
        </ul>
</fieldset>