...
<fieldset>
    ...
    [gettext][skip][url ( param="mixed" ... ) /][/skip][/gettext]
</fieldset>
...
<fieldset>
    ...
    <fieldset>
        ...
        <p>[gettext]A parameter to send to the url function. Infinite params can be passed through this method with any name.[/gettext]</p>
    </fieldset>
</fieldset>

<fieldset>
    <legend><a id="output" href="#output">[gettext]Output[/gettext]</a></legend>
    <p>[gettext]The URL.[/gettext]</p>
</fieldset>
...
<fieldset>
    <legend><a id="seealso" href="#seealso">[gettext]See Also[/gettext]</a></legend>
        <ul>
            <li><a href="[url controller="root" action="template" templatefile="tryit" parameter1="suitlons" parameter2="url" /]">[gettext]Try It[/gettext]</a></li>
