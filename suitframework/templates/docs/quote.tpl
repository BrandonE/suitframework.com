...
<p>[gettext]Quote text.[/gettext]</p>

<fieldset>
    <legend><a id="syntax" href="#syntax">[gettext]Syntax[/gettext]</a></legend>
    [gettext][skip][quote(=equal)]string[/quote][/skip][/gettext]
</fieldset>
...
<fieldset>
    ...
    <fieldset>
        ...
        <p>[gettext]The string to quote.[/gettext]</p>
    </fieldset>
    <fieldset>
        <legend><a id="equal" href="#equal">equal</a></legend>
        <p>[gettext]The creater of the quote. (Default: "". The quote will be anonymous.)[/gettext]</p>
    </fieldset>
</fieldset>
...
<fieldset>
    ...
    <fieldset>
        ...
        <p>[gettext]A string used to label this rule. (Default: "quote")[/gettext]</p>
    </fieldset>
    <fieldset>
...
<fieldset>
    <legend><a id="seealso" href="#seealso">[gettext]See Also[/gettext]</a></legend>
        <ul>
            <li><a href="[url controller="root" action="template" templatefile="tryit" parameter1="bbcode" parameter2="quote" /]">[gettext]Try It[/gettext]</a></li>
