...
<p>[gettext]Skip parsing in a certain section of the template.[/gettext]</p>

<fieldset>
    <legend><a id="syntax" href="#syntax">[gettext]Syntax[/gettext]</a></legend>
    [gettext][skip][skip]string[/skip][/skip][/gettext]
</fieldset>
...
<fieldset>
    ...
    <fieldset>
        ...
        <p>[gettext]The string not to parse.[/gettext]</p>
    </fieldset>
</fieldset>

<fieldset>
    <legend><a id="output" href="#output">[gettext]Output[/gettext]</a></legend>
    <p>[gettext]The unparsed string.[/gettext]</p>
</fieldset>
...
<fieldset>
    ...
    <ul>
        ...
        <li>[gettext]Has 'skipescape' enabled as true.[/gettext]</li>
    </ul>
</fieldset>
...
<fieldset>
    <legend><a id="seealso" href="#seealso">[gettext]See Also[/gettext]</a></legend>
        <ul>
            <li><a href="[url controller="root" action="template" templatefile="tryit" parameter1="templating" parameter2="skip" /]">[gettext]Try It[/gettext]</a></li>
