...
<p>[gettext]Reset the variables set before this section.[/gettext]</p>

<fieldset>
    <legend><a id="syntax" href="#syntax">[gettext]Syntax[/gettext]</a></legend>
    [gettext][skip][local]string[/local][/skip][/gettext]
</fieldset>
...
<fieldset>
    ...
    <fieldset>
        ...
        <p>[gettext]The string to walk through as normal.[/gettext]</p>
    </fieldset>
</fieldset>
...
<fieldset>
    ...
    <fieldset>
        ...
        <p>[gettext]The object to grab the variables from and set them to. (Default: templating.var)[/gettext]</p>
    </fieldset>
</fieldset>

<fieldset>
    <legend><a id="output" href="#output">[gettext]Output[/gettext]</a></legend>
    <p>[gettext]The walked through string. The variables will be reset.[/gettext]</p>
</fieldset>

<fieldset>
    <legend><a id="seealso" href="#seealso">[gettext]See Also[/gettext]</a></legend>
        <ul>
            <li><a href="[url controller="root" action="template" templatefile="tryit" parameter1="templating" parameter2="local" /]">[gettext]Try It[/gettext]</a></li>
        </ul>
</fieldset>