...
<p>[gettext]Modify the color of text.[/gettext]</p>

<fieldset>
    <legend><a id="syntax" href="#syntax">[gettext]Syntax[/gettext]</a></legend>
    [gettext][skip][color(=equal)]string[/color][/skip][/gettext]
</fieldset>
...
<fieldset>
    ...
    <fieldset>
        ...
        <p>[gettext]The string to change the color of.[/gettext]</p>
    </fieldset>
    <fieldset>
        <legend><a id="equal" href="#equal">equal</a></legend>
        <p>[gettext]The color to make the text. (Default: "")[/gettext]</p>
    </fieldset>
</fieldset>
...
<fieldset>
    ...
    <fieldset>
        ...
        <p>[gettext]A string used to label this rule. (Default: "color")[/gettext]</p>
    </fieldset>
    <fieldset>
...
<fieldset>
    ...
    <p>[gettext]The modified text.[/gettext]</p>
</fieldset>
...
<fieldset>
    <legend><a id="seealso" href="#seealso">[gettext]See Also[/gettext]</a></legend>
        <ul>
            <li><a href="[url controller="root" action="template" templatefile="tryit" parameter1="bbcode" parameter2="color" /]">[gettext]Try It[/gettext]</a></li>
