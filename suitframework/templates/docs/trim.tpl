...
<p>[gettext]Trim unnecessary whitespace.[/gettext]</p>

<fieldset>
    <legend><a id="syntax" href="#syntax">[gettext]Syntax[/gettext]</a></legend>
    [gettext][skip][trim]string[/trim][/skip][/gettext]
</fieldset>
...
<fieldset>
    ...
    <fieldset>
        ...
        <p>[gettext]The string to trim.[/gettext]</p>
    </fieldset>
</fieldset>

<fieldset>
    <legend><a id="output" href="#output">[gettext]Output[/gettext]</a></legend>
    <p>[gettext]The trimmed string.[/gettext]</p>
</fieldset>

<fieldset>
    <legend><a id="seealso" href="#seealso">[gettext]See Also[/gettext]</a></legend>
        <ul>
            <li><a href="[url controller="root" action="template" templatefile="tryit" parameter1="templating" parameter2="trim" /]">[gettext]Try It[/gettext]</a></li>
        </ul>
</fieldset>