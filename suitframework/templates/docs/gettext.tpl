...
<p>[gettext]Grabs a gettext string.[/gettext]</p>

<fieldset>
    <legend><a id="syntax" href="#syntax">[gettext]Syntax[/gettext]</a></legend>
    [gettext][skip][gettext]string[/gettext][/skip][/gettext]
</fieldset>
...
<fieldset>
    ...
    <fieldset>
        ...
        <p>[gettext]The string to translate using gettext.[/gettext]</p>
    </fieldset>
</fieldset>
...
<fieldset>
    <legend><a id="seealso" href="#seealso">[gettext]See Also[/gettext]</a></legend>
        <ul>
            <li><a href="[url controller="root" action="template" templatefile="tryit" parameter1="suitlons" parameter2="gettext" /]">[gettext]Try It[/gettext]</a></li>
        </ul>
</fieldset>